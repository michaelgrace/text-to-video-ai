...
from app.utils.helpers import log_response, LOG_TYPE_GPT  # Updated from utility.utils

model = "gpt-4o"
OPENAI_API_KEY = os.environ.get('OPENAI_API_KEY')  # Updated from OPENAI_KEY
